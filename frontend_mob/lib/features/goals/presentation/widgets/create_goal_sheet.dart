...
import 'package:frontend_mob/features/goals/presentation/cubit/goal_form_cubit.dart';
...
class _CreateGoalSheetState extends State<CreateGoalSheet> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocBuilder<GoalFormCubit, GoalFormState>(
                    ...
                    Wrap(
                      ...
                      children: GoalType.values.map((t) {
                        ...
                        return ChoiceChip(
                          ...
                          onSelected: (_) =>
                              context.read<GoalFormCubit>().setType(t),
                          selectedColor:
                              AppColors.primary.withValues(alpha: 0.15),
                          labelStyle: AppTextStyles.body(context).copyWith(
                            color: form.type == t ? AppColors.primary : null,
                    ...
                    GestureDetector(
                      onTap: () async {
                        ...
                        if (picked != null && context.mounted) {
                          context.read<GoalFormCubit>().setEndDate(picked);
                        }
                      },
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Text(
                              'End Date: ${DateFormat('dd MMM yyyy').format(form.endDate)}',
